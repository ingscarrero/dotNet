...
namespace SOFTTEK.SCMS.Data
{
    public class PMDataContext : DataContext, IDisposable
    {
        ...
        #endregion ComponentReplacement
        ...
        public List<SOFTTEK.SCMS.Entity.PM.TechnicalObject> GetTechnicalObjects(SOFTTEK.SCMS.Entity.PM.TechnicalObject filter)
        {
            ...
            Func<System.Data.IDataReader, SOFTTEK.SCMS.Entity.PM.TechnicalObject> mapper = (reader) =>
            {
                ...
                SOFTTEK.SCMS.Entity.PM.TechnicalObject value = new SOFTTEK.SCMS.Entity.PM.TechnicalObject
                {
                    ...
                    TOType = SOFTTEK.SCMS.Entity.PM.TechnicalObject.ParseTechnicalObjectTypeToEnum(reader["tchobj_type_object"] != null ?
        ...
        public SOFTTEK.SCMS.Entity.PM.TechnicalObject InsertTechnicalObject(SOFTTEK.SCMS.Entity.PM.TechnicalObject instance)
        {
            ...
            Func<System.Data.IDataReader, SOFTTEK.SCMS.Entity.PM.TechnicalObject> mapper = (reader) =>
            {
                ...
                SOFTTEK.SCMS.Entity.PM.TechnicalObject value = new SOFTTEK.SCMS.Entity.PM.TechnicalObject
                {
                    ...
                    TOType = SOFTTEK.SCMS.Entity.PM.TechnicalObject.ParseTechnicalObjectTypeToEnum(reader["v_tchobj_type_object"] != null ?
        ...
        public List<SOFTTEK.SCMS.Entity.Shared.Parameter<string>> GetMasterData()
        {
        ...
        public Dictionary<string, object> CreateAdvice(SOFTTEK.SCMS.Entity.PM.Advice advice)
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);
            List<SOFTTEK.SCMS.Entity.Shared.Parameter<string>> parameters = new List<Entity.Shared.Parameter<string>>();

            Dictionary<string, object> dic = new Dictionary<string, object>();
            dic.Add("EQUIPMENT", advice.TechnicalObject.ExternalIdentifier);
            dic.Add("FUNCT_LOC", Entity.PM.TechnicalObjectTypes.TechnicalObjectTypeEquipment.Equals(advice.TechnicalObject.TOType) ? advice.TechnicalObject.TechnicalLocation.ExternalIdentifier : string.Empty);
            dic.Add("PRIORITY", advice.Priority);
            dic.Add("NOTIF_DATE", DateTime.Now);
            dic.Add("SHORT_TEXT", advice.Comments);
            dic.Add("BREAKDOWN", advice.Type);
            dic.Add("STRMLFNDATE", advice.ExecutionStartAt.Date);
            dic.Add("STRMLFNTIME", advice.ExecutionStartAt.TimeOfDay);
            dic.Add("ENDMLFNDATE", advice.ExecutionFinishedAt.Date);
            dic.Add("ENDMLFNTIME", advice.ExecutionFinishedAt.TimeOfDay);

            Dictionary<string, object> rfcResponseParameters = sapDataProvider.CreateAdvice(dic);
            return rfcResponseParameters;
        }

        public List<SOFTTEK.SCMS.Entity.PM.Advice> WorkOrderNotifications(string sapOrderNumber)
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);

            Dictionary<string, object> parameters = new Dictionary<string, object>();

            parameters.Add("IM_AUFNR", sapOrderNumber);

            var result = sapDataProvider.GetWorkOrderDetails<Entity.PM.Advice>(parameters, (s) =>
            {
                if ("ZPMT_NOTIF_ORDENES".Equals(s))
                {
                    return (a) =>
                    {
                        Entity.PM.Advice advice = new Entity.PM.Advice();
                        return advice;
                    };
                }
                else
            ...
            return (List<Entity.PM.Advice>)((dynamic)result["ZPMT_NOTIF_ORDENES"]).Value;
        }

        public Dictionary<string, object> SubmitWorkOrder(Entity.PM.WorkOrder wo)
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);

            Dictionary<string, object> result = new Dictionary<string, object>();

            wo.Activities.ForEach(a =>
            {
                Dictionary<string, object> inputParameters = new Dictionary<string, object>();
                inputParameters["ORDERID"] = wo.Identifier;
                inputParameters["OPERATION"] = a.Description;
                inputParameters["CONF_TEXT"] = a.Comments;
                inputParameters["WORK_CNTR"] = wo.Workstation;

                result[a.ExternalIdentifier] = sapDataProvider.SubmitWorkOrderActivity(inputParameters);
                //inputParameters[""] =
                //result[a.Identifier] = sapDataProvider.SubmitWorkOrderActivity();
            });

            return result;
        }

        public Dictionary<string, object> RegisterMeasure(SOFTTEK.SCMS.Entity.PM.MeasurementDocument measurement)
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);
            List<SOFTTEK.SCMS.Entity.Shared.Parameter<string>> parameters = new List<Entity.Shared.Parameter<string>>();
            ...
            measurement.Measures.ForEach(m =>
            {
                Dictionary<string, object> dic = new Dictionary<string, object>();
                dic.Add("I_PUNTO", m.Identifier);
                dic.Add("I_MEDIDA", m.Value);
                dic.Add("I_USER", GetSAPUser(SecurityContext.DeviceID));
                Dictionary<string, object> rfcResponseParameters = sapDataProvider.RegisterMeasurementPoint(dic);
                results.Add(m.TechnicalObject.ExternalIdentifier, rfcResponseParameters);
            });

            return results;
        }

        public List<SOFTTEK.SCMS.Entity.PM.TechnicalObject> GetTechnicalObjects()
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);
            List<SOFTTEK.SCMS.Entity.PM.TechnicalObject> results = new List<SOFTTEK.SCMS.Entity.PM.TechnicalObject>();

            Dictionary<string, object> rfcResponseParameters = sapDataProvider.GetTecnicalObjectsRFC<SOFTTEK.SCMS.Entity.PM.TechnicalObject>((s) =>
            {
                if ("GT_OBJETO_TECNICO".Equals(s))
                {
                    return (a) => new SOFTTEK.SCMS.Entity.PM.TechnicalObject
                    {
                        ExternalIdentifier = a.Keys.Any(k => "TPLNR".Equals(k)) ? a["TPLNR"].ToString() : a["SERIAL"].ToString().TrimStart('0'),
                        Description = a.Keys.Any(k => "PLTXT".Equals(k)) ? a["PLTXT"].ToString() : a["EQKTX"].ToString(),
                        TOType = !a.Keys.Any(k => "SERIAL".Equals(k)) || string.IsNullOrEmpty(a["SERIAL"].ToString()) ? Entity.PM.TechnicalObjectTypes.TechnicalObjectTypeTechnicalLocation : Entity.PM.TechnicalObjectTypes.TechnicalObjectTypeEquipment,
                        Name = a.Keys.Any(k => "PLTXT".Equals(k)) ? a["PLTXT"].ToString() : a["EQKTX"].ToString(),
                        Placement = a["STORT"].ToString(),
                        Area = a["BEBER"].ToString(),
                        CostCenter = a["SWERK"].ToString()
                    };
                }
                else
                {
            ...
            results = (List<SOFTTEK.SCMS.Entity.PM.TechnicalObject>)((dynamic)rfcResponseParameters["GT_OBJETO_TECNICO"]).Value;
            return results;
        }

        public List<SOFTTEK.SCMS.Entity.PM.WorkOrder> GetWorkOrdersInPeriod()
        {
            SOFTTEK.SCMS.Data.External.SAPDataProvider sapDataProvider = new Data.External.SAPDataProvider(this);
            List<SOFTTEK.SCMS.Entity.PM.WorkOrder> results = new List<SOFTTEK.SCMS.Entity.PM.WorkOrder>();
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
            };
            Dictionary<string, object> rfcResponseParameters = sapDataProvider.GetWorkOrdersInPeriod<Entity.PM.WorkOrder>(parameters, (s) =>
            {
                if ("ZPMT_ORDEN_MANT".Equals(s))
                {
                    return (a) =>
                    {
                        SOFTTEK.SCMS.Entity.PM.TechnicalObject technicalObject = new Entity.PM.TechnicalObject
                        {
                            ExternalIdentifier = string.IsNullOrEmpty(a["EQUNR"].ToString()) ? a["EQUNR"].ToString() : a["TPLNR"].ToString(),
                            Description = string.IsNullOrEmpty(a["EQKTX"].ToString()) ? a["EQKTX"].ToString() : a["PLTXT"].ToString(),
                            TOType = string.IsNullOrEmpty(a["EQUNR"].ToString()) ? SOFTTEK.SCMS.Entity.PM.TechnicalObjectTypes.TechnicalObjectTypeEquipment : SOFTTEK.SCMS.Entity.PM.TechnicalObjectTypes.TechnicalObjectTypeTechnicalLocation,
                            Name = string.IsNullOrEmpty(a["EQKTX"].ToString()) ? a["EQKTX"].ToString() : a["PLTXT"].ToString(),
                            Placement = a["KTEXT"].ToString(),
                            PlannificationCenter = a["IWERK"].ToString(),
                            Area = string.Empty,
                            CostCenter = string.Empty
                        };

                        DateTime helperDateTime = default(DateTime);

                        SOFTTEK.SCMS.Entity.PM.WorkOrder workOrder = new SOFTTEK.SCMS.Entity.PM.WorkOrder
                        {
                            ExternalIdentifier = a["AUFNR"].ToString().TrimStart('0'),
                            Type = a["AUART"].ToString(),
                            Company = string.Empty,
                            Priority = a["PRIOK"].ToString(),
                            Performer = string.Empty,
                            State = string.Empty,
                            TechnicalObject = technicalObject,
                            ScheduledTo = DateTime.Now,
                            ExecutionStartAt = DateTime.TryParseExact(a["GSTRP"].ToString(), "yyyyMMdd", CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out helperDateTime) ? helperDateTime : default(DateTime),
                            ExecutionFinishedAt = DateTime.TryParseExact(a["GLTRP"].ToString(), "yyyyMMdd", CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out helperDateTime) ? helperDateTime : default(DateTime),
                            Activity = a["ILATX"].ToString()
                        };

                        Entity.PM.MaintenancePlan maintenancePlan = new Entity.PM.MaintenancePlan
                        {
                            Description = a["INNAM"].ToString(),
                            ExternalIdentifier = a["IWERK"].ToString(),
                            WorkOrder = workOrder.Identifier,
                            Comments = a["ILATX"].ToString(),
                            DeviceType = string.Empty
                        };

                        SOFTTEK.SCMS.Entity.PM.Task task = new Entity.PM.Task
                        {
                            ExternalIdentifier = string.Format("{0}-{1}", a["AUFPL"].ToString(), a["APLZL"].ToString()),
                            Name = a["LTXA1"].ToString(),
                            Description = a["LTXA1"].ToString(),
                            Performer = string.Empty,
                            StartedAt = DateTime.TryParseExact(a["GSTRP"].ToString(), "yyyyMMdd", CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out helperDateTime) ? helperDateTime : default(DateTime),
                            FinishedAt = DateTime.TryParseExact(a["GLTRP"].ToString(), "yyyyMMdd", CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out helperDateTime) ? helperDateTime : default(DateTime),
                            Comments = string.Empty,
                            DurationOperation = a["DAUNO"].ToString(),
                            QuantityCapacity = a["ANZZL"].ToString(),
                            Plan = maintenancePlan,
                            WorkOrder = workOrder,
                            Status = string.Empty
                        };

                        workOrder.Activities.Add(task);
            ...
            results = (List<SOFTTEK.SCMS.Entity.PM.WorkOrder>)((dynamic)rfcResponseParameters["ZPMT_ORDEN_MANT"]).Value;

            List<SOFTTEK.SCMS.Entity.PM.WorkOrder> grpWorkOrders = results.GroupBy(u => u.ExternalIdentifier).Select(grp => grp.ToList().First()).ToList();

            List<SOFTTEK.SCMS.Entity.PM.WorkOrder> workOrders = grpWorkOrders.ToList().Select(w =>
            {
                List<Entity.PM.Task> temp = new List<Entity.PM.Task>();
                results.GroupBy(u => u.ExternalIdentifier).Where(g => g.Key.Equals(w.ExternalIdentifier)).Select(g => g.Select(i => i.Activities)).ToList().ForEach(a => a.ToList().ForEach(e => temp.AddRange(e)));
                w.Activities = temp;
                return w;
            }).ToList();
        ...
        //public List<Entity.PM.WorkOrder> GetWorkOrders(Entity.PM.WorkOrder filter)
        //{
        //    throw new NotImplementedException();
        //}

        public string GetSAPUser(string deviceIdentifier)
        {
            return "JEGONZALEZ";
        }

        //public Entity.PM.WorkOrder CreateWorkOrder(Entity.PM.WorkOrder workOrder)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.WorkOrder UpdateWorkOrder(Entity.PM.WorkOrder workOrder)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.Task UpdateTask(Entity.PM.Task task)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.ComponentReplacement RegisterComponentReplacement(Entity.PM.ComponentReplacement submittedComponentReplacement)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.MeasurementDocument RegisterMeasurementDocument(Entity.PM.MeasurementDocument submittedMeasurementDocument)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.Measure RegisterMeasure(Entity.PM.Measure measure)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.Advice RegisterAdvice(Entity.PM.Advice advice)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.Material RegisterMaterial(Entity.PM.Material sapMaterial)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.TechnicalLocation RegisterTechnicalLocation(Entity.PM.TechnicalLocation sapTechnicalLocation)
        //{
        //    throw new NotImplementedException();
        //}

        //public Entity.PM.Equipment RegisterEquipment(Entity.PM.Equipment sapEquipment)
        //{
        //    throw new NotImplementedException();
        //}
    }
