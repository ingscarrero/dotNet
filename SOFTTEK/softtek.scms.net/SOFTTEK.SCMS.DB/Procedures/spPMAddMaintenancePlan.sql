CREATE PROCEDURE [dbo].[spPMAddMaintenancePlan]
	@token_id NVARCHAR(50), 
	@new_mntpln_external_identifier NVARCHAR(500),
	--@new_mntpln_activities NVARCHAR(500), 
	@new_mntpln_description NVARCHAR(max), 
	@new_mntpln_comments NVARCHAR(500), 
	@new_mntpln_device_type NVARCHAR(20),
	@new_mntpln_work_order BIGINT
AS
	...
	BEGIN
		...
		ELSE
			INSERT INTO [TBL_PM_MAINTENANCE_PLAN] (
			...
			VALUES (
				@new_mntpln_external_identifier,
				--@new_mntpln_activities, 
				@new_mntpln_description, 
				@new_mntpln_comments, 
				@new_mntpln_device_type,
				@new_mntpln_work_order);
