CREATE PROCEDURE [dbo].[spFAMAddInventory]
...
AS
	...
	(
		...
		@fa_usage,
		@fa_supernumber,
		@fa_capitalization_at,
		@fa_decapitalization_at,
		@fa_last_disposal_at,
		@fa_entry_at,
		@fa_created_at,
		@fa_created_by,
